...
export const SupplierProfilePage: React.FC = () => {
  ...
  const handleMessageClick = async () => {
    ...
    try {
      ...
      navigate(
        `/client/messages?conversationId=${conversation.id}&supplierId=${supplier.id}`,
        {
          state: {
  ...
  const metricsData = [
    { name: "On-time", value: performance?.onTime ?? null, color: "#4e73df" },
    {
      name: "Response",
      value: performance?.response ?? null,
      color: "#1cc88a",
    },
    { name: "Quality", value: performance?.quality ?? null, color: "#f6c23e" },
  ];
  ...
  const performanceSummary =
    performance && (performance.orderCount > 0 || performance.reviewCount > 0)
      ...
      : "This supplier has not accumulated enough delivered orders, reviews, or conversation activity yet.";
  ...
  return (
    <div className="container-fluid p-0 pb-5 supplier-profile-page">
      ...
      >
        ...
        <div
          className="px-4 pb-4"
          style={{ marginTop: "-80px", position: "relative", zIndex: 2 }}
        >
          <div className="d-flex flex-column flex-md-row align-items-end align-items-md-center gap-4">
            <div
              className="profile-avatar-shell bg-white p-1 shadow-sm rounded-4"
            ...
            <div className="flex-grow-1 pt-md-5 mt-2 mt-md-0">
              ...
              <div className="profile-meta-row d-flex flex-wrap gap-x-4 gap-y-2 fw-medium mb-3">
      ...
      {activeTab === "overview" ? (
          ...
          <div className="col-lg-8">
            <div className="row g-4 mb-4">
              <div className="col-md-6">
                <SoftCard
                  className="profile-section-card h-100 border-0 shadow-sm"
                  style={{ borderRadius: "24px" }}
                >
                  ...
                  >
                    {supplier.description ||
                      "Leading distributor and wholesale partner specialized in high-quality consumer goods for local shops and retailers. We focus on reliability, competitive pricing, and sustainable supply chains."}
                  </p>
                </SoftCard>
              </div>
              <div className="col-md-6">
                ...
                >
                  <div className="d-flex align-items-center gap-3 mb-4">
                    <div className="profile-section-icon profile-section-icon-info">
                      <User size={24} />
                    </div>
                    <h5 className="fw-bold mb-0">Company Details</h5>
                  </div>
                  <div className="d-flex flex-column gap-3">
                    <div className="profile-info-row d-flex justify-content-between align-items-center p-2 bg-light rounded-3">
                    ...
                    <div className="profile-info-row d-flex justify-content-between align-items-center p-2 bg-light rounded-3">
                      ...
                      <span className="fw-bold small">
                        {supplier.yearEstablished || "2022"}
                      </span>
                    </div>
                    <div className="profile-info-row d-flex justify-content-between align-items-center p-2 bg-light rounded-3">
                      <span className="text-muted small">Tax ID</span>
                      <span className="fw-bold small">
                        MA-{supplier.id}938485
                      </span>
                    </div>
                  </div>
                </SoftCard>
            ...
            <SoftCard
              className="profile-section-card mb-4 border-0 shadow-sm"
              style={{ borderRadius: "24px" }}
            >
              <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <Link
                  to={`/client/catalog?supplier=${encodeURIComponent(supplier.nomEntreprise)}`}
          ...
          <div className="col-lg-4">
            ...
            >
              <div className="d-flex align-items-center justify-content-between mb-4">
                <div className="d-flex align-items-center gap-3">
                  <div className="profile-section-icon profile-section-icon-success">
                    <TrendingUp size={24} />
                  </div>
            ...
            >
              ...
              <div className="d-flex flex-column gap-3">
                <div className="profile-contact-row d-flex align-items-center gap-3 p-3 bg-light rounded-4">
                  <div className="profile-contact-icon bg-white p-2 rounded-circle text-primary shadow-sm">
                    <Phone size={18} />
                  </div>
                  <div>
        ...
        <div className="row g-4">
          <div className="col-lg-4">
            <SoftCard
              className="profile-rating-card border-0 shadow-sm text-center p-4 bg-primary text-white"
              style={{ borderRadius: "24px" }}
            >
              <div className="h1 fw-bold mb-1" style={{ fontSize: "3.5rem" }}>
                {supplier.averageRating?.toFixed(1) || "0.0"}
              </div>
              <div className="d-flex justify-content-center gap-1 mb-3 text-warning">
                {[1, 2, 3, 4, 5].map((s) => (
                  <Star
                    ...
                    size={24}
                    fill={
                      s <= Math.round(supplier.averageRating || 0)
                        ? "currentColor"
                        : "none"
                    }
                  />
              ...
              <p className="mb-4 opacity-75">
                Based on {reviews.length} actual customer reviews from the
                marketplace.
              </p>
              <SoftButton
              ...
              {[5, 4, 3, 2, 1].map((star) => {
                ...
                return (
                  <div key={star} className="d-flex align-items-center gap-3">
                    <span
                      className="small fw-bold text-nowrap"
                      style={{ width: "15px" }}
                    >
                      {star}
                    </span>
                    <div
                      className="profile-breakdown-track flex-grow-1 bg-white rounded-pill overflow-hidden shadow-inset"
                      style={{ height: "8px" }}
                    >
                      <div
      ...
      >
        {selectedProduct && (
          <form onSubmit={confirmAddToCart}>
            <div className="profile-modal-surface d-flex align-items-center mb-4 p-3 bg-light rounded-4">
              <div
                className="profile-modal-thumb bg-white p-1 rounded-3 me-3 overflow-hidden shadow-sm"
              ...
              <div>
                ...
                >
                  {formatPriceDh(selectedProduct.prixUnitaire)}
                </div>
                <div className="small text-muted">
                  {selectedProduct.stockDisponible} available
                </div>
              </div>
            </div>
            <div className="mb-4">
        ...
        <form onSubmit={handleSubmitReview}>
          <div className="text-center mb-4">
            <p className="text-muted mb-3">
              How was your experience ordering from this supplier?
            </p>
            <div className="d-flex justify-content-center gap-2 mb-2">
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  key={star}
                  type="button"
                  className={`profile-star-button btn btn-link p-1 transition-all ${star <= newRating ? "active" : ""}`}
