...
export interface Commande {
    ...
    refundedAt?: string;
    refundRequestStatus?: 'NONE' | 'OPEN' | 'SUPPLIER_ACCEPTED' | 'SUPPLIER_REJECTED' | 'PARTIAL_OFFERED' | 'ESCALATED_TO_DISPUTE' | 'RESOLVED' | 'REJECTED';
    refundRequestedAt?: string;
    refundRequestMessage?: string;
    refundType?: 'FULL' | 'PARTIAL';
    refundDescription?: string;
    refundImagePath?: string;
    refundAffectedItems?: string;
    refundAffectedQuantity?: number;
    refundRequestedAmount?: number;
    refundSupplierResponseType?: 'ACCEPTED' | 'REJECTED' | 'PARTIAL_OFFERED';
    refundSupplierMessage?: string;
    refundSupplierImagePath?: string;
    refundSupplierRespondedAt?: string;
    refundSupplierOfferedAmount?: number;
    refundEscalatedToDisputeAt?: string;
